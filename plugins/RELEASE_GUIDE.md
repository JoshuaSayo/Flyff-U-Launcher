...
"version": "4.0.2-automation.5"  # Beispiel
```
...
```bash
git tag v4.0.2-automation.5
git push origin <branch>
git push origin v4.0.2-automation.5
```
...
2. Finde das Draft-Release (z. B. v4.0.2-automation.5)
3. Klicke auf "Edit"
...
- **Tag-Format**: Muss mit `v` beginnen (z. B. `v4.0.2-automation.5`)
